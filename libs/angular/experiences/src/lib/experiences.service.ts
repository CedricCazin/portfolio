...
export class ExperiencesService {
    ...
    public get experiences() {
        ...
        return this.http
            .get<Experience[]>('https://raw.githubusercontent.com/CedricCazin/CedricCazin/main/resume/resume.json')
            .pipe(
                switchMap((experiences) => {
                    const convertAllDescriptions = experiences.map((experience) => {
                        return this.http.get(experience.descriptionUrl, { responseType: 'text' }).pipe(
