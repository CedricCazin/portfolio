...
import { AfterViewInit, Component, HostBinding, Inject, Renderer2, RendererFactory2, ViewChild, computed } from '@angular/core';
import { MatIconModule, MatIconRegistry } from '@angular/material/icon';
import { DomSanitizer } from '@angular/platform-browser';
import { Language, LanguageService, MarkdownService } from '@portfolio/angular/common';
...
@Component({
    ...
    selector: 'portfolio-saas',
    templateUrl: './saas.page.html',
    styleUrls: ['./saas.page.scss'],
})
export class PortfolioSaasComponent implements AfterViewInit {
