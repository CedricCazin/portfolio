        ...
        children: [
            ...
            },
            {
                ...
                data: {
                    ...
                    markdownContainerUri: 'https://raw.githubusercontent.com/CedricCazin/tutorials/main/002-tools/index.json',
                },
                component: MarkdownContainerComponent,
            },
            {
    ...
    },
    {
        ...
        children: [
            ...
            },
            {
                ...
                loadChildren: () => import('@portfolio/angular/angular-examples').then((r) => r.ANGULAR_MATERIAL_ROUTES),
            },
            {
                path: 'nestjs',
...
export const APP_ROUTES: Route[] = [
    {
        path: 'saas',
        loadComponent: () => import('./saas/saas.page').then((m) => m.PortfolioSaasComponent),
        data: { breadcrumb: { name: undefined, icon: 'home (saas)' } },
        children: CONTENT_ROUTES,
    },
    {
        path: '',
        loadComponent: () => import('./simple/simple.page').then((m) => m.PortfolioSimpleComponent),
        data: { breadcrumb: { name: undefined, icon: 'home' } },
        children: CONTENT_ROUTES,
    },
    {
        path: '',
